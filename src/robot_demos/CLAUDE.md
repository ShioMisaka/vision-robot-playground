...
## 包内依赖
- **内部依赖**: robot_controller, robot_vision, robot_api_cpp, robot_logger
...
| `demo_vision_grasp` | robot_api_cpp::robot_api_client_lib, robot_vision::robot_vision_core, robot_vision::robot_vision_nodes, robot_logger::robot_logger_lib |
