...
class IKSolver:
    ...
    def solve(self, target_xyz, target_rpy=None):
        ...
        Returns:
            list[float]: 7 个关节角度（弧度）
        """
        initial = self._last_result if self._last_result is not None else self._make_initial()
    ...
    def forward(self, joint_angles):
        ...
        Returns:
            dict: {"pos": [x,y,z], "rpy": [r,p,y], "matrix": 4x4}
        """
        ...
        rpy = Rotation.from_matrix(matrix[:3, :3]).as_euler("xyz").tolist()
