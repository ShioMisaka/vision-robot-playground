...
using robot_vision::IVisionProcessor;
...
public:
  ...
  /// @param optical_frame_pitch camera_link→optical 旋转的 pitch 角（弧度）
  GraspTaskManager(std::shared_ptr<IRobotController> robot,
                   ...
                   double optical_frame_pitch = 3.14159265359);
